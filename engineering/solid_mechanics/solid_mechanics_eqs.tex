...
\begin{align}
    \text{Hoop Stress: } \sigma_\theta &= \frac{P_i r_i^2 - P_o r_o^2}{r_o^2 - r_i^2} + \frac{r_i^2 r_o^2 (P_i - P_o)}{r^2(r_o^2 - r_i^2)} \\[10pt]
    \text{Radial Stress: } \sigma_r &= \frac{P_i r_i^2 - P_o r_o^2}{r_o^2 - r_i^2} - \frac{r_i^2 r_o^2 (P_i - P_o)}{r^2(r_o^2 - r_i^2)}
\end{align}
